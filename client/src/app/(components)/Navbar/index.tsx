    ...
    <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black'>
        ...
        <div className="flex items-center">
            <button onClick={() => dispatch(setIsDarkMode(!isDarkMode))} 
                className={isDarkMode ? 'rounded p-2 dark:hover:bg-gray-700' : 'rounded p-2 hover:bg-gray-200'}
            >
                {isDarkMode ? (
            ...
            <Link
                href="/settings"
                className={isDarkMode ? 'h-min w-min rounded p-2 dark:hover:bg-gray-700' : 'h-min w-min rounded p-2 hover:bg-gray-200'}
            >
